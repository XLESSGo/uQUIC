...
// Source: github.com/XLESSGo/uquic/http3 (interfaces: QUICEarlyListener)
//
// Generated by this command:
//
//	mockgen -typed -package http3 -destination mock_quic_early_listener_test.go github.com/XLESSGo/uquic/http3 QUICEarlyListener
//
