...
//go:generate sh -c "go run go.uber.org/mock/mockgen -typed -build_flags=\"-tags=gomock\" -package internal -destination internal/tracer.go github.com/XLESSGo/uquic/internal/mocks/logging Tracer"
...
//go:generate sh -c "go run go.uber.org/mock/mockgen -typed -build_flags=\"-tags=gomock\" -package internal -destination internal/connection_tracer.go github.com/XLESSGo/uquic/internal/mocks/logging ConnectionTracer"
