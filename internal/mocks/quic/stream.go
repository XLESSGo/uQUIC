...
// Source: github.com/XLESSGo/uquic (interfaces: Stream)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -package mockquic -destination quic/stream.go github.com/XLESSGo/uquic Stream
//
