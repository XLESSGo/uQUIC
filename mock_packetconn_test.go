...
//
//	mockgen -typed -package quic -self_package github.com/XLESSGo/uquic -self_package github.com/XLESSGo/uquic -destination mock_packetconn_test.go net PacketConn
//
